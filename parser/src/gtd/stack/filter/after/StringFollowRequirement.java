...
public class StringFollowRequirement implements IAfterFilter{
	private final char[] string;
	
	public StringFollowRequirement(String string){
		super();
	...
	public boolean equals(Object other){
		...
		if(other instanceof StringFollowRequirement){
			StringFollowRequirement otherStringFollowRequirement = (StringFollowRequirement) other;
			
			char[] otherString = otherStringFollowRequirement.string;
